        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <InputWrap>
            ...
            {errors.email && errors.email.type === "required" && (
              <WarningMessage data-testid="email-error">Email is required</WarningMessage>
            )}
          ...
          <InputWrap>
            ...
            {errors.password && errors.password.type === "required" && (
              <WarningMessage data-testid="password-error">Password is required</WarningMessage>
            )}
            {errors.password && errors.password.type === "manual" && (
              <WarningMessage>Invalid Email or Password</WarningMessage>
            )}
          </InputWrap>
